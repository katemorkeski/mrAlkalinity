...
#may_fug$F_direct <- 7.7*10^-4 * may$fug$U_10_MSY * ()#pCO2_water - pCO2_air in uatm

# calculate Flux
may_fug$F_mol_m2_s_35ppt <- may_fug$k_cm_hr_35ppt * may_fug$K_mol_L_atm * may_fug$dfCO2wa* 1/3600 * 10
hist(may_fug$F_mol_m2_s_35ppt)
