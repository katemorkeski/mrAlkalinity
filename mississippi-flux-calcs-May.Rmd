...
ggplot(may_fug, aes(x = lat, y = F_mol_m2_s_35ppt)) +
  geom_point() +
...
ggplot(may_fug, aes(x = CTDSAL_PSS78, y = F_mol_m2_s_35ppt)) +
  geom_point() +
...
may_summary <- may_fug %>%
  select(date_time_utc, lat, long, Patm, temperature, Tin_interp, CTDSAL_PSS78, Type, xCO2_dry, Std_Offset, xCO2_corr, xCO2_interp_corr, xCO2A_Corrected, fCO2_water, fCO2_interp, dfCO2wa, U_10_MSY, Sc_35ppt, k_cm_hr_35ppt, K_mol_L_atm, F_mol_m2_s_35ppt, F_mmol_m2_d_35ppt, F_micromol_m2_s_35ppt)
